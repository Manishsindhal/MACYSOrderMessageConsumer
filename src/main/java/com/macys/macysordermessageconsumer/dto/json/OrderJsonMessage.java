package com.macys.macysordermessageconsumer.dto.json;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.macys.macysordermessageconsumer.dto.OrderStatus;
...
public class OrderJsonMessage implements Serializable {
    ...
    public OrderJsonMessage(String messageName, String imagePathname, double itemHeight, String upcList, double itemLength, String command, String itemName, String pickType, double itemWidth, String rfidTagged, String itemDescription, int storageAttribute, double itemWeight, OrderStatus orderStatus) {
