package com.macys.macysordermessageconsumer.entity.json;
...
@Entity(name = "ORDER_MESSAGE_JSON")
public class OrderJsonMessageEntity implements Serializable {
